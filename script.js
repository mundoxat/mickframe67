document.addEventListener('DOMContentLoaded', () => {
    ...
    const photoUrls = [
        "https://xatimg.com/image/WNomsplxG1xH.png",
        "https://xatimg.com/image/0JlaeEWKj6bQ.jpg",
        "https://xatimg.com/image/ZpewEzLAgMNY.png",
    ];
    ...
    const sectionContent = {
        ...
        amigos: {
            title: "Friends",
            html: `
                <p><strong>Friends:</strong>Mick,Mick1</p>
            `
        },
        galeria: {
            title: "Galery",
